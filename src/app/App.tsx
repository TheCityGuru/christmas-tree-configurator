...
const ORNAMENT_SET_2: OrnamentSet = [
  ...
  { path: '/models/ornaments/candy_shop/macaron_green.glb',               qty: 4 },
  { path: '/models/ornaments/candy_shop/macaron_purple.glb',              qty: 2 },
  { path: '/models/ornaments/candy_shop/macaron_red.glb',                 qty: 4 },
